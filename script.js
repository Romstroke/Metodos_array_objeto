...
const pacientesIsapre = copiaDental.filter(paciente =>paciente.prevision == 'ISAPRE');
...
const pacientesFonasa = copiaTraumatologia.filter(paciente =>paciente.prevision == 'FONASA');
